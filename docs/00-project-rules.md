...
[Semantic Versioning (SemVer)](https://semver.org/): `MAJOR.MINOR.PATCH`. The baseline release is `0.5.1`; this checkout builds the `0.6.0` candidate (not an npm release).
