...
export const MESSAGES = {
	...
	"app.activity.idle": { "zh-CN": "空闲", en: "Idle" },
	"app.activity.running": { "zh-CN": "正在生成…", en: "Generating…" },
	"app.activity.tool": { "zh-CN": "工具进行中 · {tool}", en: "Tool running · {tool}" },
	"app.activity.tools": {
		"zh-CN": "{n} 个工具进行中 · {tools}",
		en: "{n} tools running · {tools}",
	},
	"app.history.loadOlder": { "zh-CN": "加载更早消息", en: "Load earlier messages" },
	"app.history.loadingOlder": { "zh-CN": "正在加载…", en: "Loading…" },
